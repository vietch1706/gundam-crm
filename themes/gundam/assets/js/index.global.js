...
(() => {
    var $t = "4.0.6";
    var ke = 92, Re = 47, Oe = 42, eo = 34, to = 39, ro = 58, Ke = 59, ie = 10, we = 32, Pe = 9, Nt = 123, Xe = 125,
        rt = 40, Tt = 41, oo = 91, no = 93, Vt = 45, et = 64, io = 33;

    function de(t) {
        t = t.replaceAll(`\r
`, `
`);
        let r = [], o = [], e = [], n = null, u = null, a = "", p = "", f;
        for (let s = 0; s < t.length; s++) {
            let d = t.charCodeAt(s);
            if (d === ke) a += t.slice(s, s + 2), s += 1; else if (d === Re && t.charCodeAt(s + 1) === Oe) {
                let m = s;
                for (let b = s + 2; b < t.length; b++) if (f = t.charCodeAt(b), f === ke) b += 1; else if (f === Oe && t.charCodeAt(b + 1) === Re) {
                    s = b + 1;
                    break
                }
                let g = t.slice(m, s + 1);
                ...
                let m = s;
                for (let g = s + 1; g < t.length; g++) if (f = t.charCodeAt(g), f === ke) g += 1; else if (f === d) {
                    s = g;
                    break
                } else {
                ...
                if (d === ie) {
                    ...
                    let m = "", g = s, b = -1;
                    for (let y = s + 2; y < t.length; y++) if (f = t.charCodeAt(y), f === ke) y += 1; else if (f === Re && t.charCodeAt(y + 1) === Oe) {
                        for (let x = y + 2; x < t.length; x++) if (f = t.charCodeAt(x), f === ke) x += 1; else if (f === Oe && t.charCodeAt(x + 1) === Re) {
                            y = x + 1;
                            break
                        }
                    } else if (b === -1 && f === ro) b = a.length + y - g; else if (f === Ke && m.length === 0) {
                        a += t.slice(g, y), s = y;
                        break
                    } else if (f === rt) m += ")"; else if (f === oo) m += "]"; else if (f === Nt) m += "}"; else if ((f === Xe || t.length - 1 === y) && m.length === 0) {
                        s = y - 1, a += t.slice(g, y);
                        break
                ...
                } else if (d === Ke && a.charCodeAt(0) === et) u = xe(a), n ? n.nodes.push(u) : r.push(u), a = "", u = null; else if (d === Ke && p[p.length - 1] !== ")") {
                    let m = tt(a);
                    if (!m) throw a.length === 0 ? new Error("Unexpected semicolon") : new Error(`Invalid declaration: \`${a.trim()}\``);
                    n ? n.nodes.push(m) : r.push(m), a = ""
                } else if (d === Nt && p[p.length - 1] !== ")") p += "}", u = M(a.trim()), n && n.nodes.push(u), e.push(n), n = u, a = "", u = null; else if (d === Xe && p[p.length - 1] !== ")") {
                    if (p === "") throw new Error("Missing opening {");
                    if (p = p.slice(0, -1), a.length > 0) if (a.charCodeAt(0) === et) u = xe(a), n ? n.nodes.push(u) : r.push(u), a = "", u = null; else {
                        let g = a.indexOf(":");
                        if (n) {
                            let b = tt(a, g);
    ...
    function xe(t, r = []) {
        for (let o = 5; o < t.length; o++) {
            ...
            if (e === we || e === rt) {
                let n = t.slice(0, o).trim(), u = t.slice(o).trim();
                return z(n, u, r)
            }
        }
        return z(t.trim(), "", r)
    ...
    function pe(t) {
        ...
        var r = String(t), o = r.length, e = -1, n, u = "", a = r.charCodeAt(0);
    ...
    var Rt = new Map([["--font", ["--font-weight", "--font-size"]], ["--inset", ["--inset-shadow", "--inset-ring"]], ["--text", ["--text-color", "--text-underline-offset", "--text-indent", "--text-decoration-thickness", "--text-decoration-color"]]]);
    ...
    var _e = class {
        ...
        markUsedVariable(r) {
            let o = le(this.#o(r)), e = this.values.get(o);
            e && (e.options |= 16)
        }
    ...
    function _(t, r, o = [], e = {}) {
        for (let n = 0; n < t.length; n++) {
            ...
            o.push(u);
            let p = !1, f = 0, s = r(u, {
                parent: a, context: e, path: o, replaceWith(d) {
    ...
    function De(t, r, o = [], e = {}) {
        for (let n = 0; n < t.length; n++) {
            let u = t[n], a = o[o.length - 1] ?? null;
            if (u.kind === "rule" || u.kind === "at-rule") o.push(u), De(u.nodes, r, o, e), o.pop(); else if (u.kind === "context") {
                De(u.nodes, r, o, {...e, ...u.context});
                continue
            }
            o.push(u), r(u, {
                parent: a, context: e, path: o, replaceWith(p) {
    ...
    function ae(t, r) {
        let o = [], e = new Set, n = new I(() => new Set), u = new Set, a = new Set;
        ...
        function p(s, d, m = {}, g = 0) {
            if (s.kind === "declaration") {
                ...
                d.push(s)
            } else if (s.kind === "rule") if (s.selector === "&") for (let b of s.nodes) {
                let v = [];
            ...
            } else if (s.kind === "at-root") for (let b of s.nodes) {
                let v = [];
                p(b, v, m, 0);
        ...
        if (!1) {
            e:for (let [s, d] of n) for (let m of d) {
                ...
                if (s.splice(b, 1), s.length === 0) {
                    for (let [v, y] of f.entries()) if (y.kind === "rule" && y.nodes === s) {
                        f.splice(v, 1);
                        break
                    }
                    continue e
            ...
            for (let s of u) if (!a.has(s.params)) {
                let d = o.indexOf(s);
                o.splice(d, 1)
            }
        }
    ...
    function Y(t) {
        function r(e, n = 0) {
            let u = "", a = "  ".repeat(n);
            if (e.kind === "declaration") u += `${a}${e.property}: ${e.value}${e.important ? " !important" : ""};
`; else if (e.kind === "rule") {
                u += `${a}${e.selector} {
`;
...
`; else if (e.kind === "context" || e.kind === "at-root") return "";
    ...
    function ee(t, r, o = null) {
        for (let e = 0; e < t.length; e++) {
            let n = t[e], u = !1, a = 0, p = r(n, {
                parent: o, replaceWith(f) {
    ...
    var Ot = 92, co = 41, Kt = 58, Pt = 44, fo = 34, zt = 61, _t = 62, Dt = 60, Ut = 10, po = 40, mo = 39, jt = 47,
        It = 32, Ft = 9;
...
`);
        ...
        for (let a = 0; a < t.length; a++) {
            ...
            switch (p) {
                ...
                case fo: {
                    let f = a;
                    for (let s = a + 1; s < t.length; s++) if (u = t.charCodeAt(s), u === Ot) s += 1; else if (u === p) {
                        a = s;
                        break
                    }
                    n += t.slice(f, a + 1);
    ...
    var lt = ["calc", "min", "max", "clamp", "mod", "rem", "sin", "cos", "tan", "asin", "acos", "atan", "atan2", "pow", "sqrt", "hypot", "log", "exp", "round"],
        Ue = ["anchor-size"], Lt = new RegExp(`(${Ue.join("|")})\\(`, "g");
        ...
        for (let n = 0; n < t.length; n++) {
            ...
            if (u === "(") {
                ...
                for (let f = n - 1; f >= 0; f--) {
                    ...
                    if (s >= 48 && s <= 57) a = f; else if (s >= 97 && s <= 122) a = f; else break
                }
                let p = t.slice(a, n);
                if (lt.includes(p)) {
                    e.unshift(!0);
                ...
                e.unshift(!1);
                continue
            } else if (u === ")") o += u, e.shift(); else if (u === "," && e[0]) {
                o += ", ";
                continue
            } else {
                if (u === " " && e[0] && o[o.length - 1] === " ") continue;
                if ((u === "+" || u === "*" || u === "/" || u === "-") && e[0]) {
                    let a = o.trimEnd(), p = a[a.length - 1];
                    if (p === "+" || p === "*" || p === "/" || p === "-") {
                        o += u;
                        continue
                    } else if (p === "(" || p === ",") {
    ...
    function P(t, r) {
        let o = 0, e = [], n = 0, u = t.length, a = r.charCodeAt(0);
        for (let p = 0; p < u; p++) {
    ...
    function* Ht(t, r) {
        ...
        let u = !1;
        e[e.length - 1] === "!" ? (u = !0, e = e.slice(0, -1)) : e[0] === "!" && (u = !0, e = e.slice(1)), r.utilities.has(e, "static") && !e.includes("[") && (yield{
            kind: "static",
            root: e,
            variants: n,
            important: u,
        ...
        if (a[0] === "[") {
            ...
            let b = a.slice(0, g), v = re(a.slice(g + 1));
        ...
        if (a[a.length - 1] === "]") {
            ...
            let g = a.slice(0, m);
            if (!r.utilities.has(g, "functional")) return;
            let b = a.slice(m + 2, -1), v = P(b, ":"), y = null;
    ...
    function Gt(t, r) {
        ...
        }
        {
            ...
            for (let [a, p] of u) switch (r.variants.kind(a)) {
                case"static":
                ...
                case"functional": {
                    ...
                    if (p[p.length - 1] === "]") {
                        ...
                        return s.length === 0 || s.trim().length === 0 ? null : {
                            kind: "functional",
                            root: a,
                            modifier: f,
                    ...
                    if (p[p.length - 1] === ")") {
                        if (p[0] !== "(") continue;
                        let s = re(p.slice(1, -1));
                        return s.length === 0 || s.trim().length === 0 || s[0] !== "-" && s[1] !== "-" ? null : {
                            kind: "functional",
                            root: a,
                            modifier: f,
    ...
    function se(t, r, o) {
        if (t === r) return 0;
        let e = t.indexOf("("), n = r.indexOf("("), u = e === -1 ? t.replace(/[\d.]+/g, "") : t.slice(0, e),
    ...
    var xo = /^(?:element|image|cross-fade|image-set)\(/, Ao = /^(repeating-)?(conic|linear|radial)-gradient\(/;

    function Co(t) {
        let r = 0;
        for (let o of P(t, ",")) if (!o.startsWith("var(")) {
            if (Zt(o)) {
                r += 1;
                continue
            }
    ...
    var te = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/, Vo = new RegExp(`^${te.source}$`);
    ...
    var Po = ["cm", "mm", "Q", "in", "pc", "pt", "px", "em", "ex", "ch", "rem", "lh", "rlh", "vw", "vh", "vmin", "vmax", "vb", "vi", "svw", "svh", "lvw", "lvh", "dvw", "dvh", "cqw", "cqh", "cqi", "cqb", "cqmin", "cqmax"],
    ...
    var Uo = ["deg", "rad", "grad", "turn"], jo = new RegExp(`^${te.source}(${Uo.join("|")})$`);
    ...
    var Mo = new Set(["inset", "inherit", "initial", "revert", "unset"]), Xt = /^-?(\d+|\.\d+)(.*?)$/g;

    function ue(t, r) {
        return P(t, ",").map(e => {
            e = e.trim();
            let n = P(e, " ").filter(s => s.trim() !== ""), u = null, a = null, p = null;
            for (let s of n) Mo.has(s) || (Xt.test(s) ? (a === null ? a = s : p === null && (p = s), Xt.lastIndex = 0) : u === null && (u = s));
    ...
    var Bo = /^-?[a-z][a-zA-Z0-9/%._-]*$/, qo = /^-?[a-z][a-zA-Z0-9/%._-]*-\*$/, dt = class {
        utilities = new I(() => []);
        completions = new Map;
        ...
        keys(r) {
            let o = [];
            for (let [e, n] of this.utilities.entries()) for (let u of n) if (u.kind === r) {
                o.push(e);
                break
            }
            return o
    ...
    function tr(t) {
        ...
        function o(i, c) {
            ...
            r.suggest(i, () => {
                ...
                for (let k of c()) {
                    ...
                    k.hasDefaultValue && N.unshift(null), w.push({
        ...
        function n(i, c) {
            ...
            c.supportsNegative && r.functional(`-${i}`, h({negative: !0})), r.functional(i, h({negative: !1})), o(i, () => [{
        ...
        for (let [i, c] of [["inset", "inset"], ["inset-x", "inset-inline"], ["inset-y", "inset-block"], ["start", "inset-inline-start"], ["end", "inset-inline-end"], ["top", "top"], ["right", "right"], ["bottom", "bottom"], ["left", "left"]]) e(`${i}-auto`, [[c, "auto"]]), e(`${i}-full`, [[c, "100%"]]), e(`-${i}-full`, [[c, "-100%"]]), a(i, ["--inset", "--spacing"], h => [l(c, h)], {
            supportsNegative: !0,
            supportsFractions: !0
        });
        ...
        }]), e("order-first", [["order", "-9999"]]), e("order-last", [["order", "9999"]]), e("order-none", [["order", "0"]]), n("order", {
            supportsNegative: !0,
            handleBareValue: ({value: i}) => $(i) ? i : null,
            themeKeys: ["--order"],
            handle: i => [l("order", i)]
        ...
        for (let [i, c] of [["m", "margin"], ["mx", "margin-inline"], ["my", "margin-block"], ["ms", "margin-inline-start"], ["me", "margin-inline-end"], ["mt", "margin-top"], ["mr", "margin-right"], ["mb", "margin-bottom"], ["ml", "margin-left"]]) e(`${i}-auto`, [[c, "auto"]]), a(i, ["--margin", "--spacing"], h => [l(c, h)], {supportsNegative: !0});
        e("box-border", [["box-sizing", "border-box"]]), e("box-content", [["box-sizing", "content-box"]]), e("line-clamp-none", [["overflow", "visible"], ["display", "block"], ["-webkit-box-orient", "horizontal"], ["-webkit-line-clamp", "unset"]]), n("line-clamp", {
        ...
        for (let [i, c] of [["auto", "auto"], ["full", "100%"], ["svw", "100svw"], ["lvw", "100lvw"], ["dvw", "100dvw"], ["svh", "100svh"], ["lvh", "100lvh"], ["dvh", "100dvh"], ["min", "min-content"], ["max", "max-content"], ["fit", "fit-content"]]) e(`size-${i}`, [["--tw-sort", "size"], ["width", c], ["height", c]]), e(`w-${i}`, [["width", c]]), e(`min-w-${i}`, [["min-width", c]]), e(`max-w-${i}`, [["max-width", c]]), e(`h-${i}`, [["height", c]]), e(`min-h-${i}`, [["min-height", c]]), e(`max-h-${i}`, [["max-height", c]]);
        e("w-screen", [["width", "100vw"]]), e("min-w-screen", [["min-width", "100vw"]]), e("max-w-screen", [["max-width", "100vw"]]), e("h-screen", [["height", "100vh"]]), e("min-h-screen", [["min-height", "100vh"]]), e("max-h-screen", [["max-height", "100vh"]]), e("max-w-none", [["max-width", "none"]]), e("max-h-none", [["max-height", "none"]]), a("size", ["--size", "--spacing"], i => [l("--tw-sort", "size"), l("width", i), l("height", i)], {supportsFractions: !0});
        for (let [i, c, h] of [["w", ["--width", "--spacing", "--container"], "width"], ["min-w", ["--min-width", "--spacing", "--container"], "min-width"], ["max-w", ["--max-width", "--spacing", "--container"], "max-width"], ["h", ["--height", "--spacing"], "height"], ["min-h", ["--min-height", "--height", "--spacing"], "min-height"], ["max-h", ["--max-height", "--height", "--spacing"], "max-height"]]) a(i, c, w => [l(h, w)], {supportsFractions: !0});
        r.static("container", () => {
            ...
            valueThemeKeys: [],
            hasDefaultValue: !0
        }]), e("basis-auto", [["flex-basis", "auto"]]), e("basis-full", [["flex-basis", "100%"]]), a("basis", ["--flex-basis", "--spacing", "--container"], i => [l("flex-basis", i)], {supportsFractions: !0}), e("table-auto", [["table-layout", "auto"]]), e("table-fixed", [["table-layout", "fixed"]]), e("caption-top", [["caption-side", "top"]]), e("caption-bottom", [["caption-side", "bottom"]]), e("border-collapse", [["border-collapse", "collapse"]]), e("border-separate", [["border-collapse", "separate"]]);
        ...
        e("translate-none", [["translate", "none"]]), e("-translate-full", [f, ["--tw-translate-x", "-100%"], ["--tw-translate-y", "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), e("translate-full", [f, ["--tw-translate-x", "100%"], ["--tw-translate-y", "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), a("translate", ["--translate", "--spacing"], i => [f(), l("--tw-translate-x", i), l("--tw-translate-y", i), l("translate", "var(--tw-translate-x) var(--tw-translate-y)")], {
            supportsNegative: !0,
            supportsFractions: !0
        });
        for (let i of ["x", "y"]) e(`-translate-${i}-full`, [f, [`--tw-translate-${i}`, "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), e(`translate-${i}-full`, [f, [`--tw-translate-${i}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), a(`translate-${i}`, ["--translate", "--spacing"], c => [f(), l(`--tw-translate-${i}`, c), l("translate", "var(--tw-translate-x) var(--tw-translate-y)")], {
            supportsNegative: !0,
            supportsFractions: !0
        });
        a("translate-z", ["--translate", "--spacing"], i => [f(), l("--tw-translate-z", i), l("translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)")], {supportsNegative: !0}), e("-translate-z-px", [f, ["--tw-translate-z", "-1px"], ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]), e("translate-z-px", [f, ["--tw-translate-z", "1px"], ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]), e("translate-3d", [f, ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]);
        ...
        function d({negative: i}) {
            return c => {
                ...
                let h;
                return c.value.kind === "arbitrary" ? (h = c.value.value, [l("scale", h)]) : (h = t.resolve(c.value.value, ["--scale"]), !h && $(c.value.value) && (h = `${c.value.value}%`), h ? (h = i ? `calc(${h} * -1)` : h, [s(), l("--tw-scale-x", h), l("--tw-scale-y", h), l("--tw-scale-z", h), l("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0)
            }
        }

        r.functional("-scale", d({negative: !0})), r.functional("scale", d({negative: !1})), o("scale", () => [{
            supportsNegative: !0,
        ...
        r.functional("-rotate", m({negative: !0})), r.functional("rotate", m({negative: !1})), o("rotate", () => [{
            supportsNegative: !0,
        ...
        }]);
        {
            ...
            n("skew", {
                ...
                handle: h => [c(), l("--tw-skew-x", `skewX(${h})`), l("--tw-skew-y", `skewY(${h})`), l("transform", i)]
            }), n("skew-x", {
                supportsNegative: !0,
                themeKeys: ["--skew"],
                handleBareValue: ({value: h}) => $(h) ? `${h}deg` : null,
                handle: h => [c(), l("--tw-skew-x", `skewX(${h})`), l("transform", i)]
            }), n("skew-y", {
                supportsNegative: !0,
                themeKeys: ["--skew"],
                handleBareValue: ({value: h}) => $(h) ? `${h}deg` : null,
                handle: h => [c(), l("--tw-skew-y", `skewY(${h})`), l("transform", i)]
            }), o("skew", () => [{
                supportsNegative: !0,
                values: ["0", "1", "2", "3", "6", "12"],
                valueThemeKeys: ["--skew"]
            ...
            }), o("transform", () => [{hasDefaultValue: !0}]), e("transform-cpu", [["transform", i]]), e("transform-gpu", [["transform", `translateZ(0) ${i}`]]), e("transform-none", [["transform", "none"]])
        }
        ...
        e("snap-mandatory", [b, ["--tw-scroll-snap-strictness", "mandatory"]]), e("snap-proximity", [b, ["--tw-scroll-snap-strictness", "proximity"]]), e("snap-align-none", [["scroll-snap-align", "none"]]), e("snap-start", [["scroll-snap-align", "start"]]), e("snap-end", [["scroll-snap-align", "end"]]), e("snap-center", [["scroll-snap-align", "center"]]), e("snap-normal", [["scroll-snap-stop", "normal"]]), e("snap-always", [["scroll-snap-stop", "always"]]);
        for (let [i, c] of [["scroll-m", "scroll-margin"], ["scroll-mx", "scroll-margin-inline"], ["scroll-my", "scroll-margin-block"], ["scroll-ms", "scroll-margin-inline-start"], ["scroll-me", "scroll-margin-inline-end"], ["scroll-mt", "scroll-margin-top"], ["scroll-mr", "scroll-margin-right"], ["scroll-mb", "scroll-margin-bottom"], ["scroll-ml", "scroll-margin-left"]]) a(i, ["--scroll-margin", "--spacing"], h => [l(c, h)], {supportsNegative: !0});
        for (let [i, c] of [["scroll-p", "scroll-padding"], ["scroll-px", "scroll-padding-inline"], ["scroll-py", "scroll-padding-block"], ["scroll-ps", "scroll-padding-inline-start"], ["scroll-pe", "scroll-padding-inline-end"], ["scroll-pt", "scroll-padding-top"], ["scroll-pr", "scroll-padding-right"], ["scroll-pb", "scroll-padding-bottom"], ["scroll-pl", "scroll-padding-left"]]) a(i, ["--scroll-padding", "--spacing"], h => [l(c, h)]);
        ...
        e("grid-flow-row", [["grid-auto-flow", "row"]]), e("grid-flow-col", [["grid-auto-flow", "column"]]), e("grid-flow-dense", [["grid-auto-flow", "dense"]]), e("grid-flow-row-dense", [["grid-auto-flow", "row dense"]]), e("grid-flow-col-dense", [["grid-auto-flow", "column dense"]]), e("auto-cols-auto", [["grid-auto-columns", "auto"]]), e("auto-cols-min", [["grid-auto-columns", "min-content"]]), e("auto-cols-max", [["grid-auto-columns", "max-content"]]), e("auto-cols-fr", [["grid-auto-columns", "minmax(0, 1fr)"]]), n("auto-cols", {
            ...
            handleBareValue: ({value: i}) => ft(i) ? `repeat(${i}, minmax(0, 1fr))` : null,
        ...
        for (let [i, c] of [["rounded", ["border-radius"]], ["rounded-s", ["border-start-start-radius", "border-end-start-radius"]], ["rounded-e", ["border-start-end-radius", "border-end-end-radius"]], ["rounded-t", ["border-top-left-radius", "border-top-right-radius"]], ["rounded-r", ["border-top-right-radius", "border-bottom-right-radius"]], ["rounded-b", ["border-bottom-right-radius", "border-bottom-left-radius"]], ["rounded-l", ["border-top-left-radius", "border-bottom-left-radius"]], ["rounded-ss", ["border-start-start-radius"]], ["rounded-se", ["border-start-end-radius"]], ["rounded-ee", ["border-end-end-radius"]], ["rounded-es", ["border-end-start-radius"]], ["rounded-tl", ["border-top-left-radius"]], ["rounded-tr", ["border-top-right-radius"]], ["rounded-br", ["border-bottom-right-radius"]], ["rounded-bl", ["border-bottom-left-radius"]]]) e(`${i}-none`, c.map(h => [h, "0"])), e(`${i}-full`, c.map(h => [h, "calc(infinity * 1px)"])), n(i, {
            themeKeys: ["--radius"],
            handle: h => c.map(w => l(w, h))
        });
        e("border-solid", [["--tw-border-style", "solid"], ["border-style", "solid"]]), e("border-dashed", [["--tw-border-style", "dashed"], ["border-style", "dashed"]]), e("border-dotted", [["--tw-border-style", "dotted"], ["border-style", "dotted"]]), e("border-double", [["--tw-border-style", "double"], ["border-style", "double"]]), e("border-hidden", [["--tw-border-style", "hidden"], ["border-style", "hidden"]]), e("border-none", [["--tw-border-style", "none"], ["border-style", "none"]]);
        {
            let c = function (h, w) {
                r.functional(h, k => {
                    if (!k.value) {
                        if (k.modifier) return;
                        let N = t.get(["--default-border-width"]) ?? "1px", R = w.width(N);
                        return R ? [i(), ...R] : void 0
                    }
            ...
            c("border", {
                ...
                handle: h => [D([S("--tw-divide-x-reverse", "0")]), U(":where(& > :not(:last-child))", [l("--tw-sort", "divide-x-width"), i(), l("--tw-divide-x-reverse", "0"), l("border-inline-style", "var(--tw-border-style)"), l("border-inline-start-width", `calc(${h} * var(--tw-divide-x-reverse))`), l("border-inline-end-width", `calc(${h} * calc(1 - var(--tw-divide-x-reverse)))`)])]
            }), n("divide-y", {
                defaultValue: t.get(["--default-border-width"]) ?? "1px",
                themeKeys: ["--divide-width", "--border-width"],
                handleBareValue: ({value: h}) => $(h) ? `${h}px` : null,
                handle: h => [D([S("--tw-divide-y-reverse", "0")]), U(":where(& > :not(:last-child))", [l("--tw-sort", "divide-y-width"), i(), l("--tw-divide-y-reverse", "0"), l("border-bottom-style", "var(--tw-border-style)"), l("border-top-style", "var(--tw-border-style)"), l("border-top-width", `calc(${h} * var(--tw-divide-y-reverse))`), l("border-bottom-width", `calc(${h} * calc(1 - var(--tw-divide-y-reverse)))`)])]
            }), o("divide-x", () => [{
                values: ["0", "2", "4", "8"],
                ...
                valueThemeKeys: ["--divide-width", "--border-width"],
                hasDefaultValue: !0
            }]), e("divide-x-reverse", [() => D([S("--tw-divide-x-reverse", "0")]), () => U(":where(& > :not(:last-child))", [l("--tw-divide-x-reverse", "1")])]), e("divide-y-reverse", [() => D([S("--tw-divide-y-reverse", "0")]), () => U(":where(& > :not(:last-child))", [l("--tw-divide-y-reverse", "1")])]);
        ...
        e("bg-auto", [["background-size", "auto"]]), e("bg-cover", [["background-size", "cover"]]), e("bg-contain", [["background-size", "contain"]]), e("bg-fixed", [["background-attachment", "fixed"]]), e("bg-local", [["background-attachment", "local"]]), e("bg-scroll", [["background-attachment", "scroll"]]), e("bg-center", [["background-position", "center"]]), e("bg-top", [["background-position", "top"]]), e("bg-right-top", [["background-position", "right top"]]), e("bg-right", [["background-position", "right"]]), e("bg-right-bottom", [["background-position", "right bottom"]]), e("bg-bottom", [["background-position", "bottom"]]), e("bg-left-bottom", [["background-position", "left bottom"]]), e("bg-left", [["background-position", "left"]]), e("bg-left-top", [["background-position", "left top"]]), e("bg-repeat", [["background-repeat", "repeat"]]), e("bg-no-repeat", [["background-repeat", "no-repeat"]]), e("bg-repeat-x", [["background-repeat", "repeat-x"]]), e("bg-repeat-y", [["background-repeat", "repeat-y"]]), e("bg-repeat-round", [["background-repeat", "round"]]), e("bg-repeat-space", [["background-repeat", "space"]]), e("bg-none", [["background-image", "none"]]);
        {
            let h = function (N) {
                ...
                return R => {
                    ...
                    let C = R.value.value;
                    if (!N && c.has(C)) C = c.get(C); else if ($(C)) C = N ? `calc(${C}deg * -1)` : `${C}deg`; else return;
                    let A = h(R.modifier);
            ...
            let i = ["oklab", "oklch", "srgb", "hsl", "longer", "shorter", "increasing", "decreasing"],
                c = new Map([["to-t", "to top"], ["to-tr", "to top right"], ["to-r", "to right"], ["to-br", "to bottom right"], ["to-b", "to bottom"], ["to-bl", "to bottom left"], ["to-l", "to left"], ["to-tl", "to top left"]]);
            r.functional("-bg-linear", w({negative: !0})), r.functional("bg-linear", w({negative: !1})), o("bg-linear", () => [{
                values: [...c.keys()],
                modifiers: i
            }, {
                ...
                supportsNegative: !0,
                modifiers: i
            }]), r.functional("-bg-conic", k({negative: !0})), r.functional("bg-conic", k({negative: !1})), o("bg-conic", () => [{
                hasDefaultValue: !0,
                modifiers: i
            }, {
                values: ["0", "30", "60", "90", "120", "150", "180", "210", "240", "270", "300", "330"],
        ...
        let v = () => D([S("--tw-gradient-position"), S("--tw-gradient-from", "#0000", "<color>"), S("--tw-gradient-via", "#0000", "<color>"), S("--tw-gradient-to", "#0000", "<color>"), S("--tw-gradient-stops"), S("--tw-gradient-via-stops"), S("--tw-gradient-from-position", "0%", "<length-percentage>"), S("--tw-gradient-via-position", "50%", "<length-percentage>"), S("--tw-gradient-to-position", "100%", "<length-percentage>")]);
        ...
        y("from", {
            color: i => [v(), l("--tw-sort", "--tw-gradient-from"), l("--tw-gradient-from", i), l("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")],
            position: i => [v(), l("--tw-gradient-from-position", i)]
        }), e("via-none", [["--tw-gradient-via-stops", "initial"]]), y("via", {
            color: i => [v(), l("--tw-sort", "--tw-gradient-via"), l("--tw-gradient-via", i), l("--tw-gradient-via-stops", "var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-via) var(--tw-gradient-via-position), var(--tw-gradient-to) var(--tw-gradient-to-position)"), l("--tw-gradient-stops", "var(--tw-gradient-via-stops)")],
            position: i => [v(), l("--tw-gradient-via-position", i)]
        }), y("to", {
            color: i => [v(), l("--tw-sort", "--tw-gradient-to"), l("--tw-gradient-to", i), l("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")],
        ...
        e("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]), e("mix-blend-plus-lighter", [["mix-blend-mode", "plus-lighter"]]), e("fill-none", [["fill", "none"]]), r.functional("fill", i => {
            ...
            modifiers: Array.from({length: 21}, (i, c) => `${c * 5}`)
        }]), e("stroke-none", [["stroke", "none"]]), r.functional("stroke", i => {
            if (i.value) {
                if (i.value.kind === "arbitrary") {
                    let c = i.value.value;
        ...
        }]), e("object-contain", [["object-fit", "contain"]]), e("object-cover", [["object-fit", "cover"]]), e("object-fill", [["object-fit", "fill"]]), e("object-none", [["object-fit", "none"]]), e("object-scale-down", [["object-fit", "scale-down"]]), e("object-bottom", [["object-position", "bottom"]]), e("object-center", [["object-position", "center"]]), e("object-left", [["object-position", "left"]]), e("object-left-bottom", [["object-position", "left bottom"]]), e("object-left-top", [["object-position", "left top"]]), e("object-right", [["object-position", "right"]]), e("object-right-bottom", [["object-position", "right bottom"]]), e("object-right-top", [["object-position", "right top"]]), e("object-top", [["object-position", "top"]]), n("object", {
            themeKeys: ["--object-position"],
            handle: i => [l("object-position", i)]
        });
        for (let [i, c] of [["p", "padding"], ["px", "padding-inline"], ["py", "padding-block"], ["ps", "padding-inline-start"], ["pe", "padding-inline-end"], ["pt", "padding-top"], ["pr", "padding-right"], ["pb", "padding-bottom"], ["pl", "padding-left"]]) a(i, ["--padding", "--spacing"], h => [l(c, h)]);
        e("text-left", [["text-align", "left"]]), e("text-center", [["text-align", "center"]]), e("text-right", [["text-align", "right"]]), e("text-justify", [["text-align", "justify"]]), e("text-start", [["text-align", "start"]]), e("text-end", [["text-align", "end"]]), a("indent", ["--text-indent", "--spacing"], i => [l("text-indent", i)], {supportsNegative: !0}), e("align-baseline", [["vertical-align", "baseline"]]), e("align-top", [["vertical-align", "top"]]), e("align-middle", [["vertical-align", "middle"]]), e("align-bottom", [["vertical-align", "bottom"]]), e("align-text-top", [["vertical-align", "text-top"]]), e("align-text-bottom", [["vertical-align", "text-bottom"]]), e("align-sub", [["vertical-align", "sub"]]), e("align-super", [["vertical-align", "super"]]), n("align", {
            themeKeys: [],
            handle: i => [l("vertical-align", i)]
        }), r.functional("font", i => {
        ...
        }), o("font", () => [{values: [], valueThemeKeys: ["--font"]}, {
            values: [],
        ...
        }), o("font-stretch", () => [{values: ["50%", "75%", "90%", "95%", "100%", "105%", "110%", "125%", "150%", "200%"]}]), u("placeholder", {
            themeKeys: ["--background-color", "--color"],
            handle: i => [U("&::placeholder", [l("--tw-sort", "placeholder-color"), l("color", i)])]
        ...
        });
        {
            let i = ["var(--tw-blur,)", "var(--tw-brightness,)", "var(--tw-contrast,)", "var(--tw-grayscale,)", "var(--tw-hue-rotate,)", "var(--tw-invert,)", "var(--tw-saturate,)", "var(--tw-sepia,)", "var(--tw-drop-shadow,)"].join(" "),
                c = ["var(--tw-backdrop-blur,)", "var(--tw-backdrop-brightness,)", "var(--tw-backdrop-contrast,)", "var(--tw-backdrop-grayscale,)", "var(--tw-backdrop-hue-rotate,)", "var(--tw-backdrop-invert,)", "var(--tw-backdrop-opacity,)", "var(--tw-backdrop-saturate,)", "var(--tw-backdrop-sepia,)"].join(" "),
            ...
            r.functional("filter", k => {
            ...
            }), e("blur-none", [h, ["--tw-blur", " "], ["filter", i]]), n("backdrop-blur", {
                themeKeys: ["--backdrop-blur", "--blur"],
                handle: k => [w(), l("--tw-backdrop-blur", `blur(${k})`), l("-webkit-backdrop-filter", c), l("backdrop-filter", c)]
            }), e("backdrop-blur-none", [w, ["--tw-backdrop-blur", " "], ["-webkit-backdrop-filter", c], ["backdrop-filter", c]]), n("brightness", {
                themeKeys: ["--brightness"],
                handleBareValue: ({value: k}) => $(k) ? `${k}%` : null,
                handle: k => [h(), l("--tw-brightness", `brightness(${k})`), l("filter", i)]
                ...
                themeKeys: ["--contrast"],
                handleBareValue: ({value: k}) => $(k) ? `${k}%` : null,
                handle: k => [h(), l("--tw-contrast", `contrast(${k})`), l("filter", i)]
            }), n("backdrop-contrast", {
                ...
                handleBareValue: ({value: k}) => $(k) ? `${k}%` : null,
                defaultValue: "100%",
                handle: k => [h(), l("--tw-grayscale", `grayscale(${k})`), l("filter", i)]
                ...
                handle: k => [h(), l("--tw-hue-rotate", `hue-rotate(${k})`), l("filter", i)]
                ...
                handleBareValue: ({value: k}) => $(k) ? `${k}%` : null,
                defaultValue: "100%",
                handle: k => [h(), l("--tw-invert", `invert(${k})`), l("filter", i)]
            }), n("backdrop-invert", {
                ...
                themeKeys: ["--saturate"],
                handleBareValue: ({value: k}) => $(k) ? `${k}%` : null,
                handle: k => [h(), l("--tw-saturate", `saturate(${k})`), l("filter", i)]
            }), n("backdrop-saturate", {
                ...
                hasDefaultValue: !0
            }]), e("drop-shadow-none", [h, ["--tw-drop-shadow", " "], ["filter", i]]), n("drop-shadow", {
                themeKeys: ["--drop-shadow"],
                handle: k => [h(), l("--tw-drop-shadow", P(k, ",").map(N => `drop-shadow(${N})`).join(" ")), l("filter", i)]
            }), n("backdrop-opacity", {
        ...
        }
        {
            ...
            });
            {
                ...
                e("duration-initial", [h, ["--tw-duration", "initial"]]), r.functional("duration", w => {
                    ...
                    let k = null;
                    if (w.value.kind === "arbitrary" ? k = w.value.value : (k = t.resolve(w.value.fraction ?? w.value.value, ["--transition-duration"]), k === null && $(w.value.value) && (k = `${w.value.value}ms`)), k !== null) return [h(), l("--tw-duration", k), l("transition-duration", k)]
                })
            }
            o("delay", () => [{
        ...
        {
            let i = () => D([S("--tw-ease")]);
            e("ease-initial", [i, ["--tw-ease", "initial"]]), e("ease-linear", [i, ["--tw-ease", "linear"], ["transition-timing-function", "linear"]]), n("ease", {
                themeKeys: ["--ease"],
                handle: c => [i(), l("--tw-ease", c), l("transition-timing-function", c)]
            })
        }
        e("will-change-auto", [["will-change", "auto"]]), e("will-change-scroll", [["will-change", "scroll-position"]]), e("will-change-contents", [["will-change", "contents"]]), e("will-change-transform", [["will-change", "transform"]]), n("will-change", {
            themeKeys: [],
            handle: i => [l("will-change", i)]
        }), e("content-none", [["--tw-content", "none"], ["content", "none"]]), n("content", {
            themeKeys: [],
            handle: i => [D([S("--tw-content", '""')]), l("--tw-content", i), l("content", "var(--tw-content)")]
        });
        {
            ...
            e("contain-none", [["contain", "none"]]), e("contain-content", [["contain", "content"]]), e("contain-strict", [["contain", "strict"]]), e("contain-size", [c, ["--tw-contain-size", "size"], ["contain", i]]), e("contain-inline-size", [c, ["--tw-contain-size", "inline-size"], ["contain", i]]), e("contain-layout", [c, ["--tw-contain-layout", "layout"], ["contain", i]]), e("contain-paint", [c, ["--tw-contain-paint", "paint"], ["contain", i]]), e("contain-style", [c, ["--tw-contain-style", "style"], ["contain", i]]), n("contain", {
                themeKeys: [],
                handle: h => [l("contain", h)]
            })
        }
        e("forced-color-adjust-none", [["forced-color-adjust", "none"]]), e("forced-color-adjust-auto", [["forced-color-adjust", "auto"]]), e("leading-none", [() => D([S("--tw-leading")]), ["--tw-leading", "1"], ["line-height", "1"]]), a("leading", ["--leading", "--spacing"], i => [D([S("--tw-leading")]), l("--tw-leading", i), l("line-height", i)]), n("tracking", {
            supportsNegative: !0,
            themeKeys: ["--tracking"],
            handle: i => [D([S("--tw-tracking")]), l("--tw-tracking", i), l("letter-spacing", i)]
        }), e("antialiased", [["-webkit-font-smoothing", "antialiased"], ["-moz-osx-font-smoothing", "grayscale"]]), e("subpixel-antialiased", [["-webkit-font-smoothing", "auto"], ["-moz-osx-font-smoothing", "auto"]]);
        {
            ...
            e("normal-nums", [["font-variant-numeric", "normal"]]), e("ordinal", [c, ["--tw-ordinal", "ordinal"], ["font-variant-numeric", i]]), e("slashed-zero", [c, ["--tw-slashed-zero", "slashed-zero"], ["font-variant-numeric", i]]), e("lining-nums", [c, ["--tw-numeric-figure", "lining-nums"], ["font-variant-numeric", i]]), e("oldstyle-nums", [c, ["--tw-numeric-figure", "oldstyle-nums"], ["font-variant-numeric", i]]), e("proportional-nums", [c, ["--tw-numeric-spacing", "proportional-nums"], ["font-variant-numeric", i]]), e("tabular-nums", [c, ["--tw-numeric-spacing", "tabular-nums"], ["font-variant-numeric", i]]), e("diagonal-fractions", [c, ["--tw-numeric-fraction", "diagonal-fractions"], ["font-variant-numeric", i]]), e("stacked-fractions", [c, ["--tw-numeric-fraction", "stacked-fractions"], ["font-variant-numeric", i]])
        }
        {
            let i = () => D([S("--tw-outline-style", "solid")]);
            r.static("outline-hidden", () => [l("outline-style", "none"), z("@media", "(forced-colors: active)", [l("outline", "2px solid transparent"), l("outline-offset", "2px")])]), e("outline-none", [["--tw-outline-style", "none"], ["outline-style", "none"]]), e("outline-solid", [["--tw-outline-style", "solid"], ["outline-style", "solid"]]), e("outline-dashed", [["--tw-outline-style", "dashed"], ["outline-style", "dashed"]]), e("outline-dotted", [["--tw-outline-style", "dotted"], ["outline-style", "dotted"]]), e("outline-double", [["--tw-outline-style", "double"], ["outline-style", "double"]]), r.functional("outline", c => {
            ...
            if (i.value) {
                ...
                }
                {
                    ...
                    if (c) {
                        ...
                        return typeof w == "string" ? [l("font-size", h), l("line-height", w)] : [l("font-size", h), l("line-height", w["--line-height"] ? `var(--tw-leading, ${w["--line-height"]})` : void 0), l("letter-spacing", w["--letter-spacing"] ? `var(--tw-tracking, ${w["--letter-spacing"]})` : void 0), l("font-weight", w["--font-weight"] ? `var(--tw-font-weight, ${w["--font-weight"]})` : void 0)]
                    }
                }
            }
        }), o("text", () => [{
        ...
        }, {values: [], valueThemeKeys: ["--text"], modifiers: [], modifierThemeKeys: ["--leading"]}]);
        {
            ...
            let i = ["var(--tw-inset-shadow)", "var(--tw-inset-ring-shadow)", "var(--tw-ring-offset-shadow)", "var(--tw-ring-shadow)", "var(--tw-shadow)"].join(", "),
                c = "0 0 #0000",
                h = () => D([S("--tw-shadow", c), S("--tw-shadow-color"), S("--tw-inset-shadow", c), S("--tw-inset-shadow-color"), S("--tw-ring-color"), S("--tw-ring-shadow", c), S("--tw-inset-ring-color"), S("--tw-inset-ring-shadow", c), S("--tw-ring-inset"), S("--tw-ring-offset-width", "0px", "<length>"), S("--tw-ring-offset-color", "#fff"), S("--tw-ring-offset-shadow", c)]);
            e("shadow-initial", [h, ["--tw-shadow-color", "initial"]]), r.functional("shadow", C => {
                if (!C.value) {
                    let A = t.get(["--shadow"]);
                    return A === null ? void 0 : [h(), l("--tw-shadow", ue(A, j => `var(--tw-shadow-color, ${j})`)), l("box-shadow", i)]
                }
                if (C.value.kind === "arbitrary") {
                    let A = C.value.value;
                    switch (C.value.dataType ?? F(A, ["color"])) {
                        ...
                        default:
                            return [h(), l("--tw-shadow", ue(A, Ee => `var(--tw-shadow-color, ${Ee})`)), l("box-shadow", i)]
                    }
                }
                ...
                }
                {
                    ...
                    if (A) return C.modifier ? void 0 : [h(), l("--tw-shadow", ue(A, j => `var(--tw-shadow-color, ${j})`)), l("box-shadow", i)]
                }
                {
                ...
                if (!C.value) {
                    ...
                    return A === null ? void 0 : [h(), l("--tw-inset-shadow", ue(A, j => `var(--tw-inset-shadow-color, ${j})`)), l("box-shadow", i)]
                }
                if (C.value.kind === "arbitrary") {
                    let A = C.value.value;
                    switch (C.value.dataType ?? F(A, ["color"])) {
                ...
                }
                {
                    ...
                    if (A) return C.modifier ? void 0 : [h(), l("--tw-inset-shadow", ue(A, j => `var(--tw-inset-shadow-color, ${j})`)), l("box-shadow", i)]
                }
                {
                    let A = G(C, t, ["--box-shadow-color", "--color"]);
        ...
        return o("ring-offset", () => [{
            ...
            let c = null;
            if (i.value === null ? c = "inline-size" : i.value.kind === "arbitrary" ? c = i.value.value : i.value.kind === "named" && i.value.value === "normal" && (c = "normal"), c !== null) return i.modifier ? [l("container-type", c), l("container-name", i.modifier.value)] : [l("container-type", c)]
        }), o("@container", () => [{values: ["normal"], valueThemeKeys: [], hasDefaultValue: !0}]), r
    }

    function rr(t) {
        let r = t.params;
        return qo.test(r) ? o => {
            let e = new Set, n = new Set;
            _(t.nodes, u => {
                ...
                ee(a, p => {
                    ...
                    let f = P(H(p.nodes), ",");
                    for (let [s, d] of f.entries()) d = d.replace(/\\\*/g, "*"), d = d.replace(/--(.*?)\s--(.*?)/g, "--$1-*--$2"), d = d.replace(/\s+/g, ""), d = d.replace(/(-\*){2,}/g, "-*"), d[0] === "-" && d[1] === "-" && !d.includes("-*") && (d += "-*"), f[s] = d;
                    p.nodes = L(f.join(","));
                    for (let s of p.nodes) if (s.kind === "word" && s.value[0] === "-" && s.value[1] === "-") {
                        let d = s.value.replace(/-\*.*$/g, "");
                        p.value === "--value" ? e.add(d) : p.value === "--modifier" && n.add(d)
                    }
                }), u.value = H(a)
            }), o.utilities.functional(r.slice(0, -2), u => {
                let a = structuredClone(t), p = u.value, f = u.modifier;
                if (p === null) return;
                let s = !1, d = !1, m = !1, g = !1, b = new Map, v = !1;
                if (_([a], (y, {parent: x, replaceWith: T}) => {
                ...
                }), s && !d || m && !g || v && g || f && !v && !g) return null;
                if (v) for (let [y, x] of b) {
                    let T = x.nodes.indexOf(y);
                    T !== -1 && x.nodes.splice(T, 1)
                }
                return a.nodes
            }), o.utilities.suggest(r.slice(0, -2), () => [{
                values: o.theme.keysInNamespaces(e).map(u => u.replaceAll("_", ".")),
                modifiers: o.theme.keysInNamespaces(n).map(u => u.replaceAll("_", "."))
            }])
        } : Bo.test(r) ? o => {
    ...
    function er(t, r, o) {
        for (let e of r.nodes) if (t.kind === "named" && e.kind === "word" && e.value[0] === "-" && e.value[1] === "-") {
            ...
            if (n.endsWith("-*")) {
                ...
                let a = [u.shift()], p = o.theme.resolveWith(t.value, a, u);
                if (p) {
                    let [, f = {}] = p;
                    {
                        let s = f[u.pop()];
    ...
    var or = new RegExp(Object.keys(pt).map(t => `${t}\\(`).join("|"));
    ...
    function nr(t, r) {
        let o = L(t);
        return ee(o, (e, {replaceWith: n}) => {
            if (e.kind === "function" && e.value in pt) {
                let u = P(H(e.nodes).trim(), ",").map(p => p.trim()), a = pt[e.value](r, ...u);
                return n(L(a))
            }
        }), H(o)
    }
    ...
    function Fe(t, r) {
        let o = t.length, e = r.length, n = o < e ? o : e;
        for (let u = 0; u < n; u++) {
            let a = t.charCodeAt(u), p = r.charCodeAt(u);
            if (a !== p) {
                if (a >= 48 && a <= 57 && p >= 48 && p <= 57) {
                    let f = u, s = u + 1, d = u, m = u + 1;
                    for (a = t.charCodeAt(s); a >= 48 && a <= 57;) a = t.charCodeAt(++s);
                    for (p = r.charCodeAt(m); p >= 48 && p <= 57;) p = r.charCodeAt(++m);
                    let g = t.slice(f, s), b = r.slice(d, m);
    ...
    function lr(t) {
        ...
        for (let o of t.utilities.keys("functional")) {
            ...
            for (let n of e) for (let u of n.values) {
                let a = u === null ? o : `${o}-${u}`;
    ...
    function ar(t) {
        ...
        for (let [e, n] of t.variants.entries()) {
            let p = function ({value: f, modifier: s} = {}) {
                ...
                let b = [];
                return De(g.nodes, (v, {path: y}) => {
                    if (v.kind !== "rule" && v.kind !== "at-rule" || v.nodes.length > 0) return;
                    y.sort((V, O) => {
                        let E = V.kind === "at-rule", K = O.kind === "at-rule";
            ...
            let u = e !== "@", a = t.variants.getCompletions(e);
            switch (n.kind) {
                case"static": {
    ...
    function sr(t, r) {
        let {astNodes: o, nodeSorting: e} = oe(Array.from(r), t), n = new Map(r.map(a => [a, null])), u = 0n;
        for (let a of o) {
    ...
    var gt = class {
        ...
        compare(r, o) {
            ...
            let e = this.variants.get(r.root).order, n = this.variants.get(o.root).order, u = e - n;
            if (u !== 0) return u;
    ...
    function cr(t) {
        ...
        function a(s) {
            return s.includes("::") ? null : `&:not(${P(s, ",").map(m => (m.startsWith("&:is(") && m.endsWith(")") && (m = m.slice(5, -1)), m = m.replaceAll("&", "*"), m)).join(", ")})`
        }
        ...
        r.compound("not", 3, (s, d) => {
            ...
            }), s.kind === "rule" && s.selector === "&" && s.nodes.length === 1 && Object.assign(s, s.nodes[0]), !m) return null
        }), r.suggest("not", () => Array.from(r.keys()).filter(s => r.compoundsWith("not", s))), r.compound("group", 2, (s, d) => {
        ...
        }), r.suggest("group", () => Array.from(r.keys()).filter(s => r.compoundsWith("group", s))), r.compound("peer", 2, (s, d) => {
            if (d.variant.kind === "arbitrary" && d.variant.relative) return null;
        ...
        }), r.suggest("peer", () => Array.from(r.keys()).filter(s => r.compoundsWith("peer", s))), o("first-letter", ["&::first-letter"]), o("first-line", ["&::first-line"]), o("marker", ["& *::marker", "&::marker"]), o("selection", ["& *::selection", "&::selection"]), o("file", ["&::file-selector-button"]), o("placeholder", ["&::placeholder"]), o("backdrop", ["&::backdrop"]);
        {
            let s = function () {
        ...
        }), r.suggest("in", () => Array.from(r.keys()).filter(s => r.compoundsWith("in", s))), r.compound("has", 2, (s, d) => {
            if (d.modifier) return null;
            let m = !1;
            if (_([s], (g, {path: b}) => {
                if (g.kind !== "rule") return 0;
        ...
        }), r.suggest("has", () => Array.from(r.keys()).filter(s => r.compoundsWith("has", s))), r.functional("aria", (s, d) => {
        ...
        }), r.suggest("aria", () => ["busy", "checked", "disabled", "expanded", "hidden", "pressed", "readonly", "required", "selected"]), r.functional("data", (s, d) => {
            if (!d.value || d.modifier) return null;
        ...
        }, {compounds: 1}), o("motion-safe", ["@media (prefers-reduced-motion: no-preference)"]), o("motion-reduce", ["@media (prefers-reduced-motion: reduce)"]), o("contrast-more", ["@media (prefers-contrast: more)"]), o("contrast-less", ["@media (prefers-contrast: less)"]);
        {
            ...
            var f = s;
            {
                let d = t.namespace("--breakpoint"), m = new I(g => {
                    switch (g.kind) {
                        case"static":
                ...
                r.group(() => {
                    r.functional("max", (g, b) => {
                        if (b.modifier) return null;
                        let v = m.get(b);
                        if (v === null) return null;
                        g.nodes = [z("@media", `(width < ${v})`, g.nodes)]
                    }, {compounds: 1})
                }, (g, b) => s(g, b, "desc", m)), r.suggest("max", () => Array.from(d.keys()).filter(g => g !== null)), r.group(() => {
                    for (let [g, b] of t.namespace("--breakpoint")) g !== null && r.static(g, v => {
                        v.nodes = [z("@media", `(width >= ${b})`, v.nodes)]
                    }, {compounds: 1});
                    r.functional("min", (g, b) => {
                        if (b.modifier) return null;
                        let v = m.get(b);
                        if (v === null) return null;
                        g.nodes = [z("@media", `(width >= ${v})`, g.nodes)]
                    }, {compounds: 1})
                }, (g, b) => s(g, b, "asc", m)), r.suggest("min", () => Array.from(d.keys()).filter(g => g !== null))
            }
            {
                let d = t.namespace("--container"), m = new I(g => {
                    switch (g.kind) {
                        case"functional": {
                ...
                r.group(() => {
                    ...
                    r.functional("@", (g, b) => {
                        ...
                        if (v === null) return null;
                        g.nodes = [z("@container", b.modifier ? `${b.modifier.value} (width >= ${v})` : `(width >= ${v})`, g.nodes)]
                    }, {compounds: 1}), r.functional("@min", (g, b) => {
                        let v = m.get(b);
                        if (v === null) return null;
                        g.nodes = [z("@container", b.modifier ? `${b.modifier.value} (width >= ${v})` : `(width >= ${v})`, g.nodes)]
                    }, {compounds: 1})
                }, (g, b) => s(g, b, "asc", m)), r.suggest("@min", () => Array.from(d.keys()).filter(g => g !== null)), r.suggest("@", () => Array.from(d.keys()).filter(g => g !== null))
            }
        }
        return o("portrait", ["@media (orientation: portrait)"]), o("landscape", ["@media (orientation: landscape)"]), o("ltr", ['&:where(:dir(ltr), [dir="ltr"], [dir="ltr"] *)']), o("rtl", ['&:where(:dir(rtl), [dir="rtl"], [dir="rtl"] *)']), o("dark", ["@media (prefers-color-scheme: dark)"]), o("starting", ["@starting-style"]), o("print", ["@media print"]), o("forced-colors", ["@media (forced-colors: active)"]), r
    }
    ...
    function ht(t, r) {
        _(t, (o, {replaceWith: e}) => {
            if (o.kind === "at-rule" && o.name === "@slot") e(r); else if (o.kind === "at-rule" && (o.name === "@keyframes" || o.name === "@property")) return Object.assign(o, D([z(o.name, o.params, o.nodes)])), 1
        })
    }

    function fr(t) {
        let r = tr(t), o = cr(t), e = new I(f => Gt(f, p)), n = new I(f => Array.from(Ht(f, p))), u = new I(f => {
            let s = dr(f, p);
            try {
                he(s.map(({node: d}) => d), p)
            } catch {
            ...
            if (!(s.kind !== "function" || s.value !== "var")) return ee(s.nodes, d => {
                d.kind !== "word" || d.value[0] !== "-" || d.value[1] !== "-" || t.markUsedVariable(d.value)
            }), 1
        }), !0)), p = {
            theme: t, utilities: r, variants: o, invalidCandidates: new Set, important: !1, candidatesToCss(f) {
                let s = [];
                for (let d of f) {
                    let m = !1, {astNodes: g} = oe([d], this, {
                        onInvalidCandidate() {
                            m = !0
                        }
                    });
    ...
    function Zo(t, r) {
        ...
        let o = r.utilities.get(t.root) ?? [], e = [], n = o.filter(a => !pr(a));
        for (let a of n) {
    ...
    function $e(t, r) {
        let o = 0, e = M("&", t), n = new Set, u = new I(() => new Set), a = new I(() => new Set);
        _([e], (m, {parent: g}) => {
            if (m.kind === "at-rule") {
                if (m.name === "@keyframes") return _(m.nodes, b => {
                    if (b.kind === "at-rule" && b.name === "@apply") throw new Error("You cannot use `@apply` inside `@keyframes`.")
                }), 1;
                if (m.name === "@utility") {
                    let b = m.params.replace(/-\*$/, "");
                    a.get(b).add(m), _(m.nodes, v => {
        ...
        let p = new Set, f = [], s = new Set;

        function d(m, g = []) {
            if (!p.has(m)) {
                if (s.has(m)) {
                    let b = g[(g.indexOf(m) + 1) % g.length];
                    throw m.kind === "at-rule" && m.name === "@utility" && b.kind === "at-rule" && b.name === "@utility" && _(m.nodes, v => {
                        if (v.kind !== "at-rule" || v.name !== "@apply") return;
                        let y = v.params.split(/\s+/g);
                        for (let x of y) for (let T of r.parseCandidate(x)) switch (T.kind) {
                            case"arbitrary":
                                break;
                            case"static":
                            case"functional":
...
${Y([b])}`)
        ...
        return _(f, (m, {replaceWith: g}) => {
            ...
            let b = m.params.split(/\s+/g);
            {
                ...
                for (let x of v) if (x.kind === "rule") for (let T of x.nodes) y.push(T); else y.push(x);
                g(y)
            }
        }), o
    }
        ...
        return _(t, (a, {replaceWith: p}) => {
            if (a.kind === "at-rule" && (a.name === "@import" || a.name === "@reference")) {
                ...
                return u.push((async () => {
                    ...
                    let v = await o(s, r), y = de(v.content);
                    await yt(y, v.base, o, e + 1), b.nodes = en([X({base: v.base}, y)], d, m, g)
                })()), p(b), 1
            }
        }), u.length > 0 && await Promise.all(u), n
    }
    ...
    function We(t) {
        ...
        for (let o of P(t, ".")) {
            ...
            let e = 0;
            for (; ;) {
                let n = o.indexOf("[", e), u = o.indexOf("]", n);
                if (n === -1 || u === -1) break;
    ...
    function Ne(t, r, o, e = []) {
        for (let n of r) if (n != null) for (let u of Reflect.ownKeys(n)) {
            e.push(u);
            let a = o(t[u], n[u], e);
    ...
    function Be(t, r, o) {
        return function (n, u) {
            ...
            let f = (() => {
                let s = We(n), [d, m] = ln(t.theme, s), g = o(yr(r() ?? {}, s) ?? null);
    ...
    function ln(t, r) {
        ...
        let o = Me(r), e = new Map, n = new I(() => new Map), u = t.namespace(`--${o}`);
        ...
        for (let [d, m] of u) {
            ...
            let g = d.indexOf("--"), b = d.slice(0, g), v = d.slice(g + 2);
    ...
    var kr = 92, fn = 93, wr = 41, dn = 58, xr = 44, pn = 34, mn = 46, Ar = 62, Cr = 10, gn = 35, Sr = 91, $r = 40,
        Nr = 43, hn = 39, Tr = 32, Vr = 9, Er = 126;
...
`);
        ...
        for (let a = 0; a < t.length; a++) {
            ...
            switch (p) {
                ...
                case Er: {
                    ...
                    a = s - 1;
                    let d = t.slice(f, s), m = d.trim() === "," ? un(d) : an(d);
                ...
                case pn: {
                    let f = a;
                    for (let s = a + 1; s < t.length; s++) if (u = t.charCodeAt(s), u === kr) s += 1; else if (u === p) {
                        a = s;
                        break
                    }
                    n += t.slice(f, a + 1);
    ...
    function kt({designSystem: t, ast: r, resolvedConfig: o, featuresRef: e, referenceMode: n}) {
        let u = {
            addBase(a) {
                ...
                typeof p == "string" || Array.isArray(p) ? t.variants.static(a, f => {
                    f.nodes = Or(p, f.nodes)
                }, {compounds: ce(typeof p == "string" ? [p] : p)}) : typeof p == "object" && t.variants.fromAst(a, Q(p))
            }, matchVariant(a, p, f) {
                function s(m, g, b) {
                ...
                t.variants.group(() => {
                    t.variants.functional(a, (m, g) => {
                        ...
                        if (g.value.kind === "arbitrary") m.nodes = s(g.value.value, g.modifier, m.nodes); else if (g.value.kind === "named" && f?.values) {
                    ...
                    let b = m.value ? m.value.value : "DEFAULT", v = g.value ? g.value.value : "DEFAULT",
                        y = f?.values?.[b] ?? b, x = f?.values?.[v] ?? v;
                    if (f && typeof f.sort == "function") return f.sort({
                        value: y,
                        modifier: m.modifier?.value ?? null
                    }, {value: x, modifier: g.modifier?.value ?? null});
                    let T = d.indexOf(b), V = d.indexOf(v);
                ...
                for (let [s, d] of p) {
                    ...
                    if (qe(m, b => {
                        if (b.kind === "selector" && b.value[0] === "." && Rr.test(b.value.slice(1))) {
                            let v = b.value;
                            b.value = "&";
                            let y = He(m), x = v.slice(1), T = y === "&" ? Q(d) : [M(y, Q(d))];
                            f.get(x).push(...T), g = !0, b.value = v;
                            return
                        }
                        if (b.kind === "function" && b.value === ":not") return 1
                    }), !g) throw new Error(`\`addUtilities({ '${s}' : \u2026 })\` defines an invalid utility selector. Utilities must be a single class name and start with a lowercase letter, eg. \`.scrollbar-none\`.`)
                }
                for (let [s, d] of f) t.theme.prefix && _(d, m => {
                    if (m.kind === "rule") {
                        let g = vt(m.selector);
                        qe(g, b => {
                ...
                for (let [d, m] of Object.entries(a)) {
                    let g = function ({negative: b}) {
                        return v => {
                            ...
                            let y = f.includes("color"), x = null, T = !1;
                            {
                                let E = p?.values ?? {};
                                y && (E = Object.assign({
                                    inherit: "inherit",
                                ...
                                }, E)), v.value ? v.value.kind === "arbitrary" ? x = v.value.value : v.value.fraction && E[v.value.fraction] ? (x = E[v.value.fraction], T = !0) : E[v.value.value] ? x = E[v.value.value] : E.__BARE_VALUE__ && (x = E.__BARE_VALUE__(v.value) ?? null, T = (v.value.fraction !== null && x?.includes("/")) ?? !1) : x = E.DEFAULT ?? null
                            }
                            if (x === null) return;
                            let V;
                            {
                                let E = p?.modifiers ?? null;
                                v.modifier ? E === "any" || v.modifier.kind === "arbitrary" ? V = v.modifier.value : E?.[v.modifier.value] ? V = E[v.modifier.value] : y && !Number.isNaN(Number(v.modifier.value)) ? V = `${v.modifier.value}%` : V = null : V = null
                            }
                    ...
                    p?.supportsNegativeValues && t.utilities.functional(`-${d}`, g({negative: !0}), {types: f}), t.utilities.functional(d, g({negative: !1}), {types: f}), t.utilities.suggest(d, () => {
                        let b = p?.values ?? {}, v = new Set(Object.keys(b));
                        v.delete("__BARE_VALUE__"), v.has("DEFAULT") && (v.delete("DEFAULT"), v.add(null));
                        let y = p?.modifiers ?? {}, x = y === "any" ? [] : Object.keys(y);
                        return [{
            ...
            }, theme: Be(t, () => o.theme ?? {}, a => a), prefix(a) {
                return a
            }, config(a, p) {
                let f = o;
                if (!a) return f;
    ...
    function Q(t) {
        ...
        for (let [e, n] of o) if (typeof n != "object") {
            if (!e.startsWith("--")) {
                if (n === "@slot") {
                    r.push(M(e, [z("@slot")]));
                    continue
            ...
            r.push(l(e, String(n)))
        } else if (Array.isArray(n)) for (let u of n) typeof u == "string" ? r.push(l(e, u)) : r.push(M(e, Q(u))); else n !== null && r.push(M(e, Q(n)));
        return r
    }
    ...
    function wt(t, {config: r, base: o, path: e, reference: n}) {
        let u = [];
        for (let f of r.plugins ?? []) "__isOptionsFunction" in f ? u.push({
            ...f(),
            reference: n
        }) : "handler" in f ? u.push({...f, reference: n}) : u.push({handler: f, reference: n});
        ...
        for (let f of u) t.plugins.push(f), f.config && wt(t, {
            path: e,
            base: o,
            config: f.config,
    ...
    function xn(t) {
        let r = new Set, o = Be(t.design, () => t.theme, n), e = Object.assign(o, {theme: o, colors: Ge});
        ...
        if (t.theme.screens && typeof t.theme.screens == "object") for (let u of Object.keys(t.theme.screens)) {
    ...
    function An({center: t, padding: r, screens: o}, e) {
        let n = [], u = null;
        if (t && n.push(l("margin-inline", "auto")), (typeof r == "string" || typeof r == "object" && r !== null && "DEFAULT" in r) && n.push(l("padding-inline", typeof r == "string" ? r : r.DEFAULT)), typeof o == "object" && o !== null) {
            u = new Map;
            ...
            for (let [p, f] of Object.entries(o)) {
                if (typeof f == "object") if ("min" in f) f = f.min; else continue;
                u.set(p, z("@media", `(width >= ${f})`, [l("max-width", f)]))
            }
        }
        if (typeof r == "object" && r !== null) {
            let a = Object.entries(r).filter(([p]) => p !== "DEFAULT").map(([p, f]) => [p, e.theme.resolveValue(p, ["--breakpoint"]), f]).filter(Boolean);
            a.sort((p, f) => se(p[1], f[1], "asc"));
            for (let [p, , f] of a) if (u && u.has(p)) u.get(p).nodes.push(l("padding-inline", f)); else {
                if (u) continue;
    ...
    function jr({addVariant: t, config: r}) {
        let o = r("darkMode", null), [e, n = ".dark"] = Array.isArray(o) ? o : [o];
        if (e === "variant") {
            let u;
            if (Array.isArray(n) || typeof n == "function" ? u = n : typeof n == "string" && (u = [n]), Array.isArray(u)) for (let a of u) a === ".dark" ? (e = !1, console.warn('When using `variant` for `darkMode`, you must provide a selector.\nExample: `darkMode: ["variant", ".your-selector &"]`')) : a.includes("&") || (e = !1, console.warn('When using `variant` for `darkMode`, your selector must contain `&`.\nExample `darkMode: ["variant", ".your-selector &"]`'));
            n = u
        }
    ...
    function Fr(t, r) {
        let o = t.theme.screens || {}, e = r.variants.get("min")?.order ?? 0, n = [];
        for (let [a, p] of Object.entries(o)) {
            ...
            var u = g;
            let f = r.variants.get(a), s = r.theme.resolveValue(a, ["--breakpoint"]);
    ...
    function Lr(t, r) {
        let o = t.theme.aria || {}, e = t.theme.supports || {}, n = t.theme.data || {};
        if (Object.keys(o).length > 0) {
            let u = r.variants.get("aria"), a = u?.applyFn, p = u?.compounds;
            r.variants.functional("aria", (f, s) => {
                let d = s.value;
                return d && d.kind === "named" && d.value in o ? a?.(f, {
                    ...s,
                    value: {kind: "arbitrary", value: o[d.value]}
                }) : a?.(f, s)
            }, {compounds: p})
        }
        if (Object.keys(e).length > 0) {
            let u = r.variants.get("supports"), a = u?.applyFn, p = u?.compounds;
            r.variants.functional("supports", (f, s) => {
                let d = s.value;
                return d && d.kind === "named" && d.value in e ? a?.(f, {
                    ...s,
                    value: {kind: "arbitrary", value: e[d.value]}
                }) : a?.(f, s)
            }, {compounds: p})
        }
        if (Object.keys(n).length > 0) {
            let u = r.variants.get("data"), a = u?.applyFn, p = u?.compounds;
            r.variants.functional("data", (f, s) => {
                let d = s.value;
                return d && d.kind === "named" && d.value in n ? a?.(f, {
                    ...s,
                    value: {kind: "arbitrary", value: n[d.value]}
                }) : a?.(f, s)
            }, {compounds: p})
        }
    }
...
\`@plugin\` options must be a flat list of declarations.`);
                        ...
                        let V = T.value, O = P(V, ",").map(E => {
                            if (E = E.trim(), E === "null") return null;
                            if (E === "true") return !0;
                            if (E === "false") return !1;
                            if (Number.isNaN(Number(E))) {
                                if (E[0] === '"' && E[E.length - 1] === '"' || E[0] === "'" && E[E.length - 1] === "'") return E.slice(1, -1);
                                if (E[0] === "{" && E[E.length - 1] === "}") throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${Y([T]).trim()}\` is not supported.
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`)
                    ...
                    }, Object.keys(x).length > 0 ? x : null]), b([]), u |= 4;
                    return
                }
                if (m.name === "@config") {
        ...
        let [s, d] = await Promise.all([Promise.all(p.map(async ({id: m, base: g, reference: b}) => {
            let v = await e(m, g, "config");
            return {path: m, base: v.base, config: v.module, reference: b}
        })), Promise.all(a.map(async ([{id: m, base: g, reference: b}, v]) => {
    ...
    function Mr({designSystem: t, base: r, ast: o, globs: e, configs: n, pluginDetails: u}) {
        ...
        }), ...n], {resolvedConfig: s} = xt(t, [{
            config: Dr(t.theme),
            base: r,
            reference: !0
        }, ...f, {config: {plugins: [jr]}, base: r, reference: !0}]), {
            resolvedConfig: d,
            replacedThemeKeys: m
        } = xt(t, f);
        ...
        let g = {
            designSystem: t, ast: o, resolvedConfig: s, featuresRef: {
                set current(y) {
                    a |= y
                }
            }
        }, b = kt({...g, referenceMode: !1}), v;
...
This feature is not currently supported.`);
    ...
    async function En(t, {base: r = "", loadModule: o = Nn, loadStylesheet: e = Tn} = {}) {
        let n = 0;
        t = [X({base: r}, t)], n |= await yt(t, r, e);
        let u = null, a = new _e, p = [], f = [], s = null, d = null, m = [], g = [], b = null;
        _(t, (y, {parent: x, replaceWith: T, context: V}) => {
            if (y.kind === "at-rule") {
                ...
                if (y.name === "@variant" && (x === null ? y.nodes.length === 0 ? y.name = "@custom-variant" : (_(y.nodes, O => {
                    if (O.kind === "at-rule" && O.name === "@slot") return y.name = "@custom-variant", 2
                }), y.name === "@variant" && m.push(y)) : m.push(y)), y.name === "@custom-variant") {
                ...
                if (y.name === "@theme") {
                    ...
                    if (V.reference && (O |= 2), E) {
                        if (!$n.test(E)) throw new Error(`The prefix "${E}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
                        a.prefix = E
                    }
                    return _(y.nodes, K => {
                        ...
                        let i = Y([z(y.name, y.params, [K])]).split(`
`).map((c, h, w) => `${h === 0 || h >= w.length - 2 ? " " : ">"} ${c}`).join(`
`);
                        throw new Error(`\`@theme\` blocks must only contain custom properties or \`@keyframes\`.

${i}`)
                    }), !s && !(O & 2) ? (s = U(":root, :host", []), T([s])) : T([]), 1
                }
            }
        });
        let v = fr(a);
        ...
        if (m.length > 0) {
            for (let y of m) {
                let x = U("&", y.nodes), T = y.params, V = v.parseVariant(T);
        ...
        return n |= he(t, v), n |= $e(t, v), _(t, (y, {replaceWith: x}) => {
    ...
    async function Rn(t, r = {}) {
        let {designSystem: o, ast: e, globs: n, root: u, utilitiesNode: a, features: p} = await En(t, r);
        ...
        let s = new Set, d = null, m = 0;
        return {
            globs: n, root: u, features: p, build(g) {
                if (p === 0) return t;
    ...
    async function Br(t, r = {}) {
        let o = de(t), e = await Rn(o, r), n = o, u = t;
        return {
            ...e, build(a) {
                let p = e.build(a);
...
`;
    ...
    var Zr = "text/tailwindcss", Ze, Ct = new Set, At = "", St = document.createElement("style"),
        Jr = Promise.resolve(), Un = 1, B = new Je;

    async function jn() {
        B.start("Create compiler"), B.start("Reading Stylesheets");
        let t = document.querySelectorAll(`style[type="${Zr}"]`), r = "";
        for (let o of t) Qr(o), r += o.textContent + `
`;
        if (r.includes("@import") || (r = `@import "tailwindcss";${r}`), B.end("Reading Stylesheets", {
            size: r.length,
            changed: At !== r
        }), At !== r) {
    ...
    function Qe(t) {
        async function r() {
            if (!Ze && t !== "full") return;
            let o = Un++;
            B.start(`Build #${o} (${t})`), t === "full" && await jn(), B.start("Build"), await Ln(t), B.end("Build"), B.end(`Build #${o} (${t})`)
        }
    ...
    function Qr(t) {
        Mn.observe(t, {attributes: !0, attributeFilter: ["type"], characterData: !0, subtree: !0, childList: !0})
    }
